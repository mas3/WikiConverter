...
uses
  ...
  MarkdownConverterTest in 'MarkdownConverterTest.pas',
  PukiwikiConverterTest in 'PukiwikiConverterTest.pas',
  TextConverterTest in 'TextConverterTest.pas',
  WikiPluginTest in 'WikiPluginTest.pas';
